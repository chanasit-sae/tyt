...
a header block: GOAL, WIRING, TERMINAL settings, and EXPECTED result.
    ...
    labs/
      ch1_gpio/
        CHEATSHEET.md
        lab1_2_blink.c         Blink the blue LED (PA5).
        lab1_3_button.c        Button (PB4) turns the LED on while pressed.
        lab1_5_polling.c       Poll a button; each press toggles the LED.
      ch3_uart/
        CHEATSHEET.md
        lab3_1_tx.c            Send 'K' every second over USART2.
        lab3_4_echo.c          Echo typed characters; '1' lights the green LED.
      ch4_adc/
        CHEATSHEET.md
        lab4_1_potentiometer.c Read the pot; LED on past the midpoint (2048).
        lab4_2_ntc.c           Read the NTC; print temperature over UART.
        lab4_3_ldr.c           Read the LDR; print lux; LED on when dark.
      ch5_interrupts/
        CHEATSHEET.md
        lab5_1_uart_rx.c       UART receive by interrupt (RXNEIE).
        lab5_2_adc_eoc.c       ADC read by End-Of-Conversion interrupt (EOCIE).
        lab5_3_exti.c          Button press raises an EXTI interrupt.
